...
export const MASS_UNIT: UnitDetailTable = {
  ...
  name: 'Mass',
  rows: [
    { id: 'ng',    label: 'Nanograms',        symbol: 'ng',     toBaseFactor: 1e-9,            value: 0 },
    { id: 'pg',    label: 'Picograms',        symbol: 'pg',     toBaseFactor: 1e-12,           value: 0 },
    { id: 'μg',    label: 'Micrograms',       symbol: 'μg',     toBaseFactor: 1e-6,            value: 0 },
    { id: 'mg',    label: 'Milligrams',       symbol: 'mg',     toBaseFactor: 1e-3,            value: 0 },
    { id: 'cg',    label: 'Centigrams',       symbol: 'cg',     toBaseFactor: 1e-2,            value: 0 },
    { id: 'dg',    label: 'Decigrams',        symbol: 'dg',     toBaseFactor: 1e-1,            value: 0 },
